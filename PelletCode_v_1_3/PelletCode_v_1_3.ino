...
Have program spit out timestamps, so that dimension value can be calculated by hand,
to see if there is any round error in the calculation
...
bool pistonUp()
{
  ...
  */
  ...
  return (sensorOneVal < sensorOneUL && sensorOneDelta == 0 && sensorTwoVal > sensorTwoLL);
  //return false;
}
